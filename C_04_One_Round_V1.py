...
user_points += user_two + user_two
comp_points += comp_one + comp_two

# Output the results
print("\nInitial Points")
print(f"User     - Roll 1: {user_one} \t| Roll 2: \t| Total: {user_points} ")
print(f"Computer - Roll 1: {comp_one} \t| Roll 2: \t| Total: {comp_points} ")
